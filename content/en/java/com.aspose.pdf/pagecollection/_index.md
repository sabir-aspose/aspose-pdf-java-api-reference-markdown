...
source_url: "https://reference.aspose.com/pdf/java/com.aspose.pdf/pagecollection/"
generated_from: "online-reference"
fetched_at: "2026-06-15T17:59:22+00:00"
---
**Inheritance:**
java.lang.Object
...
| [add(List pages)](#add-java.util.List-com.aspose.pdf.Page--) | Adds to collection all pages from list. |
| [add(Iterable pages)](#add-java.lang.Iterable-com.aspose.pdf.Page--) | Adds to collection all pages from list. |
...
| [insert(int pageNumber, Iterable pages)](#insert-int-java.lang.Iterable-com.aspose.pdf.Page--) | Inserts pages from the collection into document. |
| [insert(int pageNumber, List pages)](#insert-int-java.util.List-com.aspose.pdf.Page--) | Inserts pages from the collection into document. |
...
### add(List pages) {#add-java.util.List-com.aspose.pdf.Page--}
...
### add(Iterable pages) {#add-java.lang.Iterable-com.aspose.pdf.Page--}
...
### insert(int pageNumber, Iterable pages) {#insert-int-java.lang.Iterable-com.aspose.pdf.Page--}
...
### insert(int pageNumber, List pages) {#insert-int-java.util.List-com.aspose.pdf.Page--}
