...
source_url: "https://reference.aspose.com/pdf/java/com.aspose.pdf.printing/printerpaperkind/"
generated_from: "online-reference"
fetched_at: "2026-06-15T17:54:55+00:00"
---
**Inheritance:**
java.lang.Object
...
| Field | Description |
| --- | --- |
| [A2](#A2) | Standard paper format |
| [A3](#A3) | Standard paper format |
| [A3Extra](#A3Extra) | Standard paper format |
| [A3ExtraTransverse](#A3ExtraTransverse) | Standard paper format |
| [A3Rotated](#A3Rotated) | Standard paper format |
| [A3Transverse](#A3Transverse) | Standard paper format |
| [A4](#A4) | Standard paper format |
| [A4Extra](#A4Extra) | Standard paper format |
| [A4Plus](#A4Plus) | Standard paper format |
| [A4Rotated](#A4Rotated) | Standard paper format |
| [A4Small](#A4Small) | Standard paper format |
| [A4Transverse](#A4Transverse) | Standard paper format |
| [A5](#A5) | Standard paper format |
| [A5Extra](#A5Extra) | Standard paper format |
| [A5Rotated](#A5Rotated) | Standard paper format |
| [A5Transverse](#A5Transverse) | Standard paper format |
| [A6](#A6) | Standard paper format |
| [A6Rotated](#A6Rotated) | Standard paper format |
| [APlus](#APlus) | Standard paper format |
| [B4](#B4) | Standard paper format |
| [B4Envelope](#B4Envelope) | Standard paper format |
| [B4JisRotated](#B4JisRotated) | Standard paper format |
| [B5](#B5) | Standard paper format |
| [B5Envelope](#B5Envelope) | Standard paper format |
| [B5Extra](#B5Extra) | Standard paper format |
| [B5JisRotated](#B5JisRotated) | Standard paper format |
| [B5Transverse](#B5Transverse) | Standard paper format |
| [B6Envelope](#B6Envelope) | Standard paper format |
| [B6Jis](#B6Jis) | Standard paper format |
| [B6JisRotated](#B6JisRotated) | Standard paper format |
| [BPlus](#BPlus) | Standard paper format |
...
| [DSheet](#DSheet) | Standard paper format |
| [ESheet](#ESheet) | Standard paper format |
| [Executive](#Executive) | Standard paper format |
| [Folio](#Folio) | Standard paper format |
| [GermanLegalFanfold](#GermanLegalFanfold) | Standard paper format |
| [GermanStandardFanfold](#GermanStandardFanfold) | Standard paper format |
| [InviteEnvelope](#InviteEnvelope) | Standard paper format |
| [IsoB4](#IsoB4) | Standard paper format |
| [ItalyEnvelope](#ItalyEnvelope) | Standard paper format |
| [JapaneseDoublePostcard](#JapaneseDoublePostcard) | Standard paper format |
| [JapaneseDoublePostcardRotated](#JapaneseDoublePostcardRotated) | Standard paper format |
| [JapaneseEnvelopeChouNumber3](#JapaneseEnvelopeChouNumber3) | Standard paper format |
| [JapaneseEnvelopeChouNumber3Rotated](#JapaneseEnvelopeChouNumber3Rotated) | Standard paper format |
| [JapaneseEnvelopeChouNumber4](#JapaneseEnvelopeChouNumber4) | Standard paper format |
| [JapaneseEnvelopeChouNumber4Rotated](#JapaneseEnvelopeChouNumber4Rotated) | Standard paper format |
| [JapaneseEnvelopeKakuNumber2](#JapaneseEnvelopeKakuNumber2) | Standard paper format |
| [JapaneseEnvelopeKakuNumber2Rotated](#JapaneseEnvelopeKakuNumber2Rotated) | Standard paper format |
| [JapaneseEnvelopeKakuNumber3](#JapaneseEnvelopeKakuNumber3) | Standard paper format |
| [JapaneseEnvelopeKakuNumber3Rotated](#JapaneseEnvelopeKakuNumber3Rotated) | Standard paper format |
| [JapaneseEnvelopeYouNumber4](#JapaneseEnvelopeYouNumber4) | Standard paper format |
| [JapaneseEnvelopeYouNumber4Rotated](#JapaneseEnvelopeYouNumber4Rotated) | Standard paper format |
| [JapanesePostcard](#JapanesePostcard) | Standard paper format |
| [JapanesePostcardRotated](#JapanesePostcardRotated) | Standard paper format |
| [Ledger](#Ledger) | Standard paper format |
| [Legal](#Legal) | Standard paper format |
| [LegalExtra](#LegalExtra) | Standard paper format |
| [Letter](#Letter) | Standard paper format |
| [LetterExtra](#LetterExtra) | Standard paper format |
| [LetterExtraTransverse](#LetterExtraTransverse) | Standard paper format |
| [LetterPlus](#LetterPlus) | Standard paper format |
| [LetterRotated](#LetterRotated) | Standard paper format |
| [LetterSmall](#LetterSmall) | Standard paper format |
| [LetterTransverse](#LetterTransverse) | Standard paper format |
| [MonarchEnvelope](#MonarchEnvelope) | Standard paper format |
| [Note](#Note) | Standard paper format |
| [Number10Envelope](#Number10Envelope) | Standard paper format |
| [Number11Envelope](#Number11Envelope) | Standard paper format |
| [Number12Envelope](#Number12Envelope) | Standard paper format |
| [Number14Envelope](#Number14Envelope) | Standard paper format |
| [Number9Envelope](#Number9Envelope) | Standard paper format |
| [PersonalEnvelope](#PersonalEnvelope) | Standard paper format |
| [Prc16K](#Prc16K) | Standard paper format |
| [Prc16KRotated](#Prc16KRotated) | Standard paper format |
| [Prc32K](#Prc32K) | Standard paper format |
| [Prc32KBig](#Prc32KBig) | Standard paper format |
| [Prc32KBigRotated](#Prc32KBigRotated) | Standard paper format |
| [Prc32KRotated](#Prc32KRotated) | Standard paper format |
| [PrcEnvelopeNumber1](#PrcEnvelopeNumber1) | Standard paper format |
| [PrcEnvelopeNumber10](#PrcEnvelopeNumber10) | Standard paper format |
| [PrcEnvelopeNumber1Rotated](#PrcEnvelopeNumber1Rotated) | Standard paper format |
| [PrcEnvelopeNumber2](#PrcEnvelopeNumber2) | Standard paper format |
| [PrcEnvelopeNumber2Rotated](#PrcEnvelopeNumber2Rotated) | Standard paper format |
| [PrcEnvelopeNumber3](#PrcEnvelopeNumber3) | Standard paper format |
| [PrcEnvelopeNumber3Rotated](#PrcEnvelopeNumber3Rotated) | Standard paper format |
| [PrcEnvelopeNumber4](#PrcEnvelopeNumber4) | Standard paper format |
| [PrcEnvelopeNumber4Rotated](#PrcEnvelopeNumber4Rotated) | Standard paper format |
| [PrcEnvelopeNumber5](#PrcEnvelopeNumber5) | Standard paper format |
| [PrcEnvelopeNumber5Rotated](#PrcEnvelopeNumber5Rotated) | Standard paper format |
| [PrcEnvelopeNumber6](#PrcEnvelopeNumber6) | Standard paper format |
| [PrcEnvelopeNumber6Rotated](#PrcEnvelopeNumber6Rotated) | Standard paper format |
| [PrcEnvelopeNumber7](#PrcEnvelopeNumber7) | Standard paper format |
| [PrcEnvelopeNumber7Rotated](#PrcEnvelopeNumber7Rotated) | Standard paper format |
| [PrcEnvelopeNumber8](#PrcEnvelopeNumber8) | Standard paper format |
| [PrcEnvelopeNumber8Rotated](#PrcEnvelopeNumber8Rotated) | Standard paper format |
| [PrcEnvelopeNumber9](#PrcEnvelopeNumber9) | Standard paper format |
| [PrcEnvelopeNumber9Rotated](#PrcEnvelopeNumber9Rotated) | Standard paper format |
| [Quarto](#Quarto) | Standard paper format |
| [Standard10x11](#Standard10x11) | Standard paper format |
| [Standard10x14](#Standard10x14) | Standard paper format |
| [Standard11x17](#Standard11x17) | Standard paper format |
| [Standard12x11](#Standard12x11) | Standard paper format |
| [Standard15x11](#Standard15x11) | Standard paper format |
| [Standard9x11](#Standard9x11) | Standard paper format |
| [Statement](#Statement) | Standard paper format |
